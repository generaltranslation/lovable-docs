...
<AccordionGroup>
  <Accordion title="Can I download the code Lovable generates?">
    Yes\! You can access and manage your generated code via our [GitHub integration](/en/integrations/git-integration).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="What are credits in Lovable?">
    Credits are used for AI-powered actions like generating code or making
    edits. Each message you send to the AI costs one credit.
  </Accordion>
  ...
  <Accordion title="How do I get more credits?">
    ...
    More information
    [here](https://docs.lovable.dev/user-guides/messaging-limits#upgrading-and-downgrading-plans).
  </Accordion>
  ...
  <Accordion title="How does Lovable ensure data security?">
    Lovable follows [industry-standard security
    practices](https://lovable.dev/privacy), including encryption, secure API
    connections, and regular security audits to protect user data.
  </Accordion>
</AccordionGroup>
